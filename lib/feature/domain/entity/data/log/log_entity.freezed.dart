...
abstract class $LogEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? name, String? message, String? createdAt});
}
...
class _$LogEntityImpl implements _LogEntity {
  _$LogEntityImpl({this.id, this.name, this.message, this.createdAt});
  ...
  @override
  String toString() {
    return 'LogEntity(id: $id, name: $name, message: $message, createdAt: $createdAt)';
  }
...
abstract class _LogEntity implements LogEntity {
  factory _LogEntity(
      ...
      final String? name,
      final String? message,
      final String? createdAt}) = _$LogEntityImpl;
